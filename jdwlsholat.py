...
# Jdwlsholat
# Coded by Nedi Senja
# Github: https://github.com/stepbystepexe/Jdwlsholat
...
Author      : Nedi Senja
Tujuan      : Mengingaktkan kita pada waktu sholat
              spesial Ramadhan 1442 H
...
example = """\033[0;44;77;1m[        Jadwal Sholat, My Github: @stepbystepexe        ]\033[0m"""

logo = """
\033[0;31m  ▀▀▀▀█ █▀▀▀▄ \033[0;37m█ █ █ █     \033[0;32m█▀▀▀ █  █ █▀▀█ █    █▀▀█ ▀▀█▀▀\033[0m
\033[0;31m      █ █   █ \033[0;37m█ █ █ █     \033[0;32m▀▀▀█ █▀▀█ █  █ █    █▀▀█   █\033[0m
\033[0;31m  ▀▀▀▀  ▀▀▀▀  \033[0;37m▀▀▀▀▀ ▀▀▀▀  \033[0;32m▀▀▀▀ ▀  ▀ ▀▀▀▀ ▀▀▀▀ ▀  ▀   ▀\033[0m
"""
...
def gettime():
      write('\n\033[0m[\033[96;1m●\033[0m] \033[77;1mMemperbarui jadwal ...\033[0m\n')
      try:
...
def gettown():
      print()
      print()
      write("\033[0m[=\033[47;90;1m DAFTAR KOTA DI WILAYAH INDONESIA \033[0m=]\033[0m")
      sleep(1)
      print()
      ...
      sleep(0.1)
      print()
      inp = input('\033[0m[\033[95;1m+\033[0m] \033[77;1mMasukan Kota Anda: \033[0m')
      if int(inp) <= 82:
                  pass
...
def start():
      ...
      try:
            ...
            if tt > s and tt < d:
                  ...
                  ss = 'sholat Isya'
            elif tt > i and tt < s or tt < 2400 and im < s and tt < im:
                  ss = 'Imsak'
            else:
                  ss = 'sholat Subuh'
            os.system('clear')
            ...
            print(example)
            print(f'''
\033[0mJadwal waktu sholat \033[96;2m {tm('%d %B, %Y')}
\033[0muntuk kota\033[96;2m {o[7]} \033[0mdan sekitarnya.
...
Sedang menantikan waktu\033[96;2m {ss}...
\n\033[0;77;1;4mTekan Ctrl + C untuk kembali\033[0m\n''')
            while True:
                  tt = int(tm('%H%M'))
                  time = tm('%H:%M:%S')
                  if tt == s:
                        ...
                        print(logo)
                        print(example)
                        print(f'\n\033[0m[\033[92;1m●\033[0m] \033[77;1mSAATNYA ADZAN SUBUH\033[0m\nuntuk wilayah kota\033[93m {o[7]} \033[0mdan sekitarnya\033[0m\n')
                        sholat()
                        start()
                        break
                  elif tt == d:
                        ...
                        print(logo)
                        print(example)
                        print(f'\n\033[0m[\033[92;1m●\033[0m] \033[0;77;1mSAATNYA ADZAN DZUHUR\033[0m\nuntuk wilayah kota\033[93m {o[7]} \033[0mdan sekitarnya\033[0m\n')
                        sholat()
                        start()
                        break
                  elif tt == a:
                        ...
                        print(logo)
                        print(example)
                        print(f'\n\033[0m[\033[92;1m●\033[0m] \033[0;77;1mSAATNYA ADZAN ASHAR\033[0m\nuntuk wilayah kota\033[93m {o[7]} \033[0mdan sekitarnya\033[0m\n')
                        sholat()
                        start()
                        break
                  elif tt == m:
                        ...
                        print(logo)
                        print(example)
                        print(f'\n\033[0m[\033[92;1m●\033[0m] \033[0;77;1mSAATNYA ADZAN MAGHRIB\033[0m\nuntuk wilayah kota\033[93m {o[7]} \033[0mdan sekitarnya\033[0m\n')
                        sholat()
                        start()
                        break
                  elif tt == i:
                        ...
                        print(logo)
                        print(example)
                        print(f'\n\033[0m[\033[92;1m●\033[0m] \033[0;77;1mSAATNYA ADZAN ISYA\033[0m\nuntuk wilayah kota\033[96m {o[7]} \033[0mdan sekitarnya\033[0m\n')
                        sholat()
                        start()
                        break
                  elif tt == im:
                        ...
                        print(logo)
                        print(example)
                        print(f'\n\033[0m[\033[94;1m★\033[0m] \033[0;77;1mWAKTU IMSAK\033[0m\nuntuk wilayah kota\033[96m {o[7]} \033[0mdan sekitarnya\033[0m\n')
                        puasa()
                        start()
                        break
                  elif tt == saur:
                        ...
                        print(logo)
                        print(example)
                        print(f'\n\033[0m[\033[95;1m◈\033[0m] \033[0;77;1mWAKTUNYA BANGUN SAHUR\033[0m\nuntuk wilayah kota \033[92m {o[7]} \033[0mdan sekitarnya\n\033[95mKredit: https://youtu.be/EXjt18hF6UY\033[0m\n')
                        puasa()
                        start()
                        break
                  else:
                        print('\r\033[0m[\033[94;1m●\033[0m] Sekarang Jam\033[91;1;2m {} '.format(time),end=''),;sys.stdout.flush();sleep(1)
...
def sholat():
      ...
      st = ['\033[4;1mALHAMDULILLAH SUDAH ADZAN, LANGSUNG SHOLAT AJA GAN\033[0m']
      for i in st:
      	print(i.center(60))
...
def menu():
      ...
      print(example)
      print()
      print("\033[0m[\033[1;96;2m1\033[0m] \033[1;77mAktifkan Sekarang")
      print("\033[0m[\033[1;96;2m2\033[0m] \033[1;77mGanti Kota")
      print()
      ...
      if option.strip() in '1 aktifkan'.split():
            write('\n\033[0m[\033[96;1m●\033[0m] \033[77;1mMengaktifkan jadwal ...\033[0m')
            start()
            ...
            os.system('clear')
            print(example)
            os.system('toilet -f smslant Sholat')
            print(info)
            sleep(1)
            print()
            input('[ Tekan Enter ]')
