...
def gettime():
      write('\n\033[0m[\033[94;1m●\033[0m] \033[77;1mMemperbarui jadwal ...\033[0m\n')
      try:
...
\n\033[0;77;1;4mTekan Ctrl + C untuk kembali\033[0m\n''')
            while True:
                  ...
                  if tt == s:
                        print(logo)
                        print(example)
                        print('\033[0mSAATNYA ADZAN SUBUH\n \033[0muntuk wilayah\n kota \033[92m{o[7]} \033[0mdan sekitarnya\033[0m')
                        sholat()
                        start()
                        break
                  elif tt == d:
                        print(logo)
                        print(example)
                        print('\033[0mSAATNYA ADZAN DZUHUR\n \033[0muntuk wilayah\n kota \033[92m{o[7]} \033[0mdan sekitarnya\033[0m')
                        sholat()
                        start()
                        break
                  elif tt == a:
                        print(logo)
                        print(example)
                        print('\033[0mSAATNYA ADZAN ASHAR\n \033[0muntuk wilayah\n kota \033[92m{o[7]} \033[0mdan sekitarnya\033[0m')
                        sholat()
                        start()
                        break
                  elif tt == m:
                        print(logo)
                        print(example)
                        print('\033[0mSAATNYA ADZAN MAGHRIB\n \033[0muntuk wilayah\n kota \033[92m{o[7]} \033[0mdan sekitarnya\033[0m')
                        sholat()
                        start()
                        break
                  elif tt == i:
                        print(logo)
                        print(example)
                        print('\033[0mSAATNYA ADZAN ISYA\n \033[0muntuk wilayah\n kota \033[92m{o[7]} \033[0mdan sekitarnya\033[0m')
                        sholat()
                        start()
                        break
                  elif tt == im:
                        ...
                        print(logo)
                        print(example)
                        print('\033[0mWAKTUNYA BANGUN SAHUR\n \033[0muntuk wilayah\n kota \033[92m{o[7]} \033[0mdan sekitarnya\n\n \033[94mKredit:{x} https://youtu.be/EXjt18hF6UY\033[0m')
                        puasa()
                        start()
                        break
                  else:
                        print('\r\033[0m[\033[93;1m*\033[0m] Sekarang Jam\033[91;1;2m {} '.format(time),end=''),;sys.stdout.flush();sleep(1)
...
def menu():
      ...
      if option.strip() in '1 aktifkan'.split():
            write('\n\033[0m[\033[94;1m●\033[0m] \033[77;1mMengaktifkan jadwal ...\033[0m')
            start()
